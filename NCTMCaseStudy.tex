...
Figure \ref{fig:ZoneLoadForContainer29vsNOAAOAT} shows the zone load for FPVAV-2-9 versus \oat{}. FPVAV-2-9 serves only internal zones, and the load only ranges from approximately 250 BTU/hr to 4,000 BTU/hr. 
...
\newcommand{\MaxDampCaption}[1]{Maximum damper position versus \oat{} for #1 during the month of April 2016.}

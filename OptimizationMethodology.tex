...
\si{\btu\per\pound\per\degreeF}, and the temperatures are in
\si{\degreeF}.
...
This section is a bit of an aside and is presented to show the dead end
that resulted given the following setup. 

...
\usepackage{siunitxext}  %% My personal sytle file which adds english units to sinunitx
...
\usepackage{algorithm2e}  %% For displaying the algorithm deterimining optimal supply air temperature. 

...
In various situations related to steady state analysis of the energy    
use of an air handling unit, ramp functions are found. These ramp       
...
\eqreftext{} \ref{eq:ThresholdFunction} results in the family of solutions
\begin{equation}
